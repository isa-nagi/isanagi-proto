...
public:
  ...
  /// Tests whether the target is {{ Xpu }}.
  bool is{{ Xpu }}() const {
    return getArch() == Triple::{{ xpu }}32le ||
           getArch() == Triple::{{ xpu }}32be ||
           getArch() == Triple::{{ xpu }}64le ||
           getArch() == Triple::{{ xpu }}64be;
  }
