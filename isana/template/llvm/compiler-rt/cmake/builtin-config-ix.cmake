...
set(WASM32 wasm32)
set(WASM64 wasm64)
set({{ Xpu }}32LE {{ xpu }}32le)
set({{ Xpu }}32BE {{ xpu }}32be)
set({{ Xpu }}64LE {{ xpu }}64le)
set({{ Xpu }}64BE {{ xpu }}64be)
set(VE ve)
...
set(ALL_BUILTIN_SUPPORTED_ARCH
  ...
  {% raw %}${{% endraw %}{{ Xpu }}32LE{% raw %}}{% endraw %}
  {% raw %}${{% endraw %}{{ Xpu }}32BE{% raw %}}{% endraw %}
  {% raw %}${{% endraw %}{{ Xpu }}64LE{% raw %}}{% endraw %}
  {% raw %}${{% endraw %}{{ Xpu }}64BE{% raw %}}{% endraw %}
