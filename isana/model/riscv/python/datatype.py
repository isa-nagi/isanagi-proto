...
ImmS20O12 = ImmS("ImmS20O12", width=20, offset=12)
ImmS6 = ImmS("ImmS6", width=6)
ImmS9 = ImmS("ImmS9", width=9)
ImmS32O2 = ImmS("ImmS32O2", width=32, offset=2)
ImmS5O2 = ImmS("ImmS5O2", width=5, offset=2)
ImmS5O3 = ImmS("ImmS5O3", width=5, offset=3)
ImmS5O4 = ImmS("ImmS5O4", width=5, offset=4)
ImmS11O1 = ImmS("ImmS11O1", width=11, offset=1)
ImmS6O2 = ImmS("ImmS6O2", width=6, offset=2)
ImmS6O3 = ImmS("ImmS6O3", width=6, offset=3)
ImmS6O4 = ImmS("ImmS6O4", width=6, offset=4)
ImmS8O1 = ImmS("ImmS8O1", width=8, offset=1)
ImmS2O4 = ImmS("ImmS2O4", width=2, offset=4)
ImmU4 = ImmU("ImmU4", width=4)
RMImm = ImmU("RMImm", width=3, enums={
    0: "rne",
    1: "rtz",
    2: "rdn",
    3: "rup",
